-- Fix production database schema for Typeform webhook compatibility
-- This migration ensures all required columns exist for webhook functionality
...
AND column_name IN ('company_name', 'phone_number')
ORDER BY ordinal_position;
...
AND column_name IN ('content', 'details', 'description', 'order_position', 'content_data', 'content_type', 'is_published')
ORDER BY ordinal_position;
